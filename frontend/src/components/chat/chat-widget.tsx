  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-6 right-6 w-14 h-14 rounded-full shadow-lg bg-gradient-to-br from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 transition-all z-50 flex items-center justify-center border-0 cursor-pointer"
        )}
      >
        {isOpen ? (
      ...
      {isOpen && (
        <div 
          className="fixed bottom-24 right-6 w-[360px] h-[520px] shadow-2xl z-50 border border-orange-200 bg-white rounded-2xl overflow-hidden flex flex-col"
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white flex-shrink-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-semibold">小 paw 智能助手</span>
            </div>
            <button
          ...
          <div className="p-3 border-t border-gray-200 bg-white flex-shrink-0">
            <div className="flex gap-2">
              <input
                ...
                placeholder="输入你的问题..."
                disabled={isLoading}
                className="flex-1 text-sm h-10 px-3 rounded-lg border border-gray-300 focus:border-orange-400 focus:outline-none focus:ring-1 focus:ring-orange-200"
              />
              <button 
                onClick={handleSend} 
                disabled={!input.trim() || isLoading}
                className="h-10 px-4 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-300 text-white rounded-lg flex items-center justify-center transition-colors"
              >
