...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100">
        ...
        <div className="container mx-auto px-4 pt-12 pb-16 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Search Box - 更紧凑 */}
            <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-2xl mx-auto mb-8 animate-fade-in delay-200">
      ...
      {/* Pets Section - 立即展示结果 */}
      <section className="py-10 bg-gradient-to-b from-background to-orange-50/50">
        <div className="container mx-auto px-4">
